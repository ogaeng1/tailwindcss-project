...
const Premier = () => {
  ...
  function getLeagueStandings() {
    return axios.get("https://api-football-v1.p.rapidapi.com/v3/standings", {
      params: { season: "2022", league: "39" },
      headers: {
        "X-RapidAPI-Key": "cead0b265cmshc5af2c360488200p1aee41jsn793cfb87dadb",
  ...
  useEffect(() => {
    axios.all([getLeagueStandings(), getTopScorer(), getTopAssist()]).then(
      axios.spread(function (res1, res2, res3) {
        setRank(res1.data.response[0].league.standings[0]);
        setScorer(res2.data.response);
        setAssist(res3.data.response);
      })
    );
  }, []);
  console.log("도움왕", assist);
  return (
    <Layout>
      <div className="flex">
        <Menu />
